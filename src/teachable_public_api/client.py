...
import httpx
import typing
from teachable_public_api.environment import Environment
from teachable_public_api.core import AsyncBaseClient, SyncBaseClient, AuthKeyHeader
from teachable_public_api.resources.v1 import AsyncV1Client, V1Client
    ...
    def __init__(
        ...
        *,
        ...
        self._base_client.register_auth(
            "ApiKeyAuth", AuthKeyHeader(header_name="apiKey", val=api_key)
        )
